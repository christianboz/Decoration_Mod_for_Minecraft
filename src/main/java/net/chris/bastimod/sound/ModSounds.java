package net.chris.bastimod.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENT =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, BastiMod.MOD_ID);
    ...
    public static final RegistryObject<SoundEvent> DRIPSTONE_BASTI = registerSoundEvents("dripstone_basti");

    public static final ForgeSoundType SOUND_BLOCK_SOUND = new ForgeSoundType(1f,1f,
            ModSounds.SOUND_BLOCK_BREAK, ModSounds.SOUND_BLOCK_STEP, ModSounds.SOUND_BLOCK_PLACE,
            ModSounds.SOUND_BLOCK_HIT, ModSounds.SOUND_BLOCK_FALL);

    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENT.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(BastiMod.MOD_ID, name)));
    }
